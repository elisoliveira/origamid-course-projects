(function ($, window) {
  $.fn.origamidMenu = function (options) {
    ...
    var styles =
      "<style>\
            #origamid-menu { background-color: " +
      background +
      "; top: " +
      settings.top +
      "px; }\
            #origamid-menu li { border-color: " +
      color +
      "; }\
            #origamid-menu li:last-of-type { border-color: " +
      color +
      "; }\
            #origamid-menu li a { color: " +
      color +
      "; }\
            #origamid-menu li a:hover { color: " +
      background +
      "; background: " +
      color +
      "; }\
            #origamid-icon::before { background:" +
      color +
      "; }\
            #origamid-icon::after { box-shadow: 0 4px 0 0 " +
      color +
      ", 0 -4px 0 0 " +
      color +
      "; }\
            #origamid-icon.active::before, #origamid-icon.active::after { background:" +
      color +
      "; }\
          </style>";
